...
The Nexis Gateway provides a real-time WebSocket endpoint at `/ws` for bidirectional communication. All messages are JSON-encoded.

## Authentication

Nexis uses a **first-message authentication** pattern to keep tokens out of URLs and logs.
